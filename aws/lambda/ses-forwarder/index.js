...
var defaultConfig = {
  fromEmail: 'colby@devdead.ly',
  subjectPrefix: '(devdeadly) ',
  emailBucket: 'devdeadly',
  ...
  forwardMapping: {
     ...
     *
     * 1.  @devdead.ly will catch all email send to the domain and forward it
     *     to the array of emails listed
     *
     * 2.  The email sent to xxxxxx@devdead.ly will physically landed in the email
     *     inbox of the listed email (e.g. coloradocolby@gmail.com)
     *
     * 3.  If SMTP has been configured on the email client (e.g. gmail) the user
     *     can then choose to send email with their personal xxxxx@devdead.ly email
     **/
    '@devdead.ly': [
      // catch all
      'coloradocolby@gmail.com',
    ],
  },
}
    ...
    data.s3.copyObject(
      {
        ...
        CopySource:
          data.config.emailBucket + '/' + data.config.emailKeyPrefix + data.email.messageId,
